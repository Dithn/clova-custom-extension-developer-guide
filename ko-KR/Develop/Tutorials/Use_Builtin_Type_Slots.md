...
<ol>
  ...
  <li><p><strong>{{ book.DevConsole.cek_builder_list_title_slottype }}</strong> 오른쪽에 있는 <img class="inlineImage" src="/Develop/Assets/Images/DevConsole_Plus_Button.png" /> 버튼을 누릅니다.</p></li>
  <li>
...
<ol>
  ...
  <li><p>엔터키 또는 오른쪽에 있는 <img class="inlineImage" src="/Develop/Assets/Images/DevConsole_Plus_Button.png" /> 버튼을 누릅니다.</p></li>
